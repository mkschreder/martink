...
COMMON_FLAGS := -MD -ffunction-sections -fdata-sections -Wall -Werror -Wuninitialized -Werror=implicit-function-declaration -Werror=strict-prototypes -Wno-pointer-to-int-cast -Wno-int-to-pointer-cast -Os
CFLAGS := 
CXXFLAGS := 
