...
static m2_button_fnptr m2_el_buttonptr_get_callback(m2_el_fnarg_p fn_arg)
{
  return (m2_button_fnptr)m2_rom_get_fnptr(fn_arg->element, offsetof(m2_el_buttonptr_t, button_callback));
}
