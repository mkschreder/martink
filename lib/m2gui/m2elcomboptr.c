...
static m2_get_str_fnptr m2_el_comboptr_get_str_fnptr(m2_el_fnarg_p fn_arg)
{
  return (m2_get_str_fnptr)m2_rom_get_fnptr(fn_arg->element, offsetof(m2_el_comboptr_t, get_str_fnptr));
}

static const char *m2_el_comboptr_get_str(m2_el_fnarg_p fn_arg, uint8_t idx)
{
  return m2_el_comboptr_get_str_fnptr(fn_arg)(idx);
}

static uint8_t m2_el_comboptr_get_max_len_idx(m2_el_fnarg_p fn_arg)
{
...
static void m2_el_comboptr_inc(m2_el_fnarg_p fn_arg)
{
...
static void m2_el_comboptr_dec(m2_el_fnarg_p fn_arg)
{
  uint8_t *val_ptr = m2_el_setval_get_val_ptr(fn_arg);
  if ( *val_ptr == 0 )
...
static const char *m2_el_comboptr_get_curr_str(m2_el_fnarg_p fn_arg)
{
